...
GameState::GameState()
    : selectedUnit(nullptr), currentTurn(1), currentPlayer(0), maxTurns(20), showOptionsMenu(false), showMechbayScreen(false), mechbayFilterFocused(false), showAttackLines(false) {
	initializeMap();
	initializeMechBay();
}
