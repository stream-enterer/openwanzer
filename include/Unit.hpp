...
struct Unit {
	...
	// **NEW: 3D Polyhedron armor system**
	PolyhedronShape polyShape;
	...
	void initializePolyhedron(WeightClass wClass, PolyhedronShape shape);
	bool isAlive() const;
	bool canMove() const;
